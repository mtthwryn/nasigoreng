...
const PrivacyPolicyPage = () => (
  <div className="container">
    ...
    <p>
      Your privacy is important to us. It is UCLA Singaporean Students
      Association&#39;s policy to respect your privacy and comply with any
      applicable law and regulation regarding any personal information we may
      collect about you, including across our website,{" "}
      <a href="https://uclassa.org">https://uclassa.org</a>, and other sites we
      own and operate.
    </p>
    <p>
      This policy is effective as of 29 March 2022 and was last updated on 29
      March 2022.
    </p>
    ...
    <p>
      You have the right to request for the deletion of any personal data
      collected from you, and may do so by emailing us at {" "}
      <a href="mailto:ssa.uclabruins@gmail.com">ssa.uclabruins@gmail.com</a>.
      When a request is received, we will delete your user profile and any other
      personally identifying data from our databases.
    </p>
